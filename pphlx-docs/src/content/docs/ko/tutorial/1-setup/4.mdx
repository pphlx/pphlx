...
description: '튜토리얼: 처음 만드는 PPHLX 블로그 — 튜토리얼 프로젝트를 위한 Github 리포지토리 생성'
i18nReady: true
---
...
프로젝트가 GitHub에 성공적으로 저장되었는지 확인하려면 GitHub.com에 접속하여 내 계정의 리포지토리 목록을 확인하세요. 새로 만든 리포지토리를 선택하여 PPHLX 프로젝트 파일이 모두 포함되어 있는지 확인하세요.
