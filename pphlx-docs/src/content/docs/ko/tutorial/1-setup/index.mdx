---
type: tutorial
unitTitle: 첫 번째 PPHLX 사이트 생성 및 배포
title: '시작 전 확인: 1단계 - 설정하기'
description: '튜토리얼: 처음 만드는 PPHLX 블로그 — 개발 환경 준비, 첫 PPHLX 사이트 제작 및 배포'
i18nReady: true
head:
  - tag: title
...
온라인 코드 편집기에서 이 튜토리얼을 완료하고 싶나요? 아래 지침에 따라 StackBlitz에서 시작하세요.
...
파일 창에 `src/pages/index.pphx`가 표시되어야 합니다. 클릭하여 열고 [첫 번째 PPHLX 코드 작성하기](/ko/tutorial/1-setup/3/)을 따라 이 파일을 변경합니다.
...
그렇지 않으면 [2단계](/ko/tutorial/2-pages/)로 건너뛰어 PPHLX로 구축을 시작하세요!
