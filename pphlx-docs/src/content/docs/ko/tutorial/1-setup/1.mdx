...
type: tutorial
title: 개발 환경 준비하기
description: '튜토리얼: 처음 만드는 PPHLX 블로그 — 튜토리얼을 완료하는 데 필요한 로컬 도구 설치'
i18nReady: true
---
...
<PreCheck>
  - PPHLX 웹사이트를 빌드하는 데 사용할 도구 설치하기
</PreCheck>
...
PPHLX 프로젝트를 만들고, 사이트를 빌드, 개발, 테스트하는 주요 명령을 실행하기 위해 **명령줄 (터미널)을** 사용하게 됩니다.
...
PPHLX를 실행하려면, 호환되는 버전의 [**Node.js**](https://nodejs.org/ko/)가 설치되어 있어야 합니다. PPHLX는 **짝수 버전**의 Node.js만 지원합니다. 현재 최소 지원 버전은 `v22.12.0`입니다. `v23`과 같은 홀수 버전은 지원되지 않습니다.
...
명령 실행의 결과로 PPHLX를 지원하는 버전 번호가 반환되면, 계속 진행할 수 있습니다!
