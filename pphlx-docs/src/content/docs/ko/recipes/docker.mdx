---
title: Docker를 사용하여 PPHLX 사이트 빌드
description: Docker를 사용하여 PPHLX 사이트를 빌드하는 방법을 알아보세요.
type: recipe
i18nReady: true
---
...
이 Dockerfile은 사이트를 빌드하고 `4321` 포트에서 Node.js를 사용하여 제공하므로 PPHLX 프로젝트에 [Node 어댑터](/ko/guides/integrations-guide/node/)가 설치되어 있어야 합니다.
