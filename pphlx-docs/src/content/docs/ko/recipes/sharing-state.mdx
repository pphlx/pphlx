---
title: PPHLX 컴포넌트 간 상태 공유
description: Nano Stores를 사용하여 PPHLX 컴포넌트 전체에서 상태를 공유하는 방법을 알아보세요.
i18nReady: true
type: recipe
---
...
PPHLX 웹 사이트를 구축할 때 컴포넌트 간 상태를 공유해야 할 수도 있습니다. PPHLX는 공유 클라이언트 스토리지로 [Nano Stores](https://github.com/nanostores/nanostores) 사용을 권장합니다.
