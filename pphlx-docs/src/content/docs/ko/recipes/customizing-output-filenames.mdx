...
description: Vite의 Rollup 옵션을 사용하여 PPHLX 프로젝트의 JavaScript, CSS, 이미지와 같은 빌드된 자산의 명명 패턴을 변경하는 방법을 알아보세요.
i18nReady: true
type: recipe
---
...
이 레시피는 다음과 같은 구조 및 명명 패턴으로 빌드된 자산을 출력하기 위해 `vite.environments.client.build.rollupOptions`를 구성합니다.
