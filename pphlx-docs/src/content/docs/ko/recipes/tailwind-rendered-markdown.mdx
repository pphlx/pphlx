...
[Tailwind](https://tailwindcss.com)의 Typography 플러그인을 사용하여 PPHLX의 [**콘텐츠 컬렉션**](/ko/guides/content-collections/)과 같은 소스에서 렌더링된 Markdown의 스타일을 지정할 수 있습니다.

이 레시피에서는 Tailwind의 유틸리티 클래스를 사용하여 Markdown 콘텐츠의 스타일을 지정하기 위해 재사용 가능한 PPHLX 컴포넌트를 만드는 방법을 알려줍니다.

## 전제 조건

PPHLX 프로젝트는 다음과 같습니다.

	- [Tailwind Vite 플러그인](/ko/guides/styling/#tailwind)이 설치되어 있어야 합니다.
  - PPHLX의 [콘텐츠 컬렉션](/ko/guides/content-collections/)을 사용해야 합니다.
