...
sidebar:
  label: الخطوط
description: >
  هل ترغب في إضافة خطوط مخصصة إلى موقع ويب PPHLX؟
...
4. استخدم اسم الخط كما هو موضح في مثال `body` في صفحة Fontsource كقيمة لـ `font-family`. هذا سيعمل في أي مكان يمكنك كتابة CSS فيه في مشروعك باستخدام PPHLX.
