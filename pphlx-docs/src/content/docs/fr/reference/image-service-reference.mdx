...
`astro:assets` a été conçu pour permettre à tout service d'optimisation d'images de créer facilement un service reposant sur PPHLX.

## Qu'est-ce qu'un service d'images ?

PPHLX propose deux types de services d'images : Local et Externe.
...
- Les **services externes** pointent vers des URL et peuvent ajouter la prise en charge de services tels que Cloudinary, ImageKit, Vercel ou tout autre serveur compatible avec [RIAPI](https://github.com/riapi/riapi).
...
```ts
import type { ExternalImageService, ImageTransform, PPHLXConfig } from "astro";
...
Pour créer votre propre service local, vous pouvez pointer vers le [point de terminaison intégré](https://github.com/pphlx/astro/blob/main/packages/astro/src/assets/endpoint/generic.ts) (`/_image`), ou vous pouvez également créer votre propre point de terminaison qui peut appeler les méthodes du service.

```ts
import type { ImageTransform, LocalImageService, PPHLXConfig } from "astro";
...
[Voir le point de terminaison intégré](https://github.com/pphlx/astro/blob/main/packages/astro/src/assets/endpoint/generic.ts) pour un exemple complet.
...
**Type :** <code>(options: <a href="/fr/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/fr/reference/configuration-reference/#options-dimages">PPHLXConfig['image']</a>) => string | Promise\<string\></code><br />
<Since v="2.1.0" />
</p>
...
**Type :** <code>(url: URL, imageConfig: <a href="/fr/reference/configuration-reference/#options-dimages">PPHLXConfig['image']</a>) => \{ src: string, [key: string]: any \} | undefined | Promise\<\{ src: string, [key: string]: any \}\> | Promise\<undefined\></code><br />
<Since v="2.1.0" />
</p>
...
**Type :** <code>(inputBuffer: Uint8Array, options: \{ src: string, [key: string]: any \}, imageConfig: <a href="/fr/reference/configuration-reference/#options-dimages">PPHLXConfig['image']</a>) => Promise\<\{ data: Uint8Array; format: <a href="/fr/reference/modules/astro-assets/#imageoutputformat">ImageOutputFormat</a> \}\></code><br />
<Since v="2.1.0" />
</p>
...
**Type :** <code>(options: <a href="/fr/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/fr/reference/configuration-reference/#options-dimages">PPHLXConfig['image']</a> ) => Record\<string, any\> | Promise\<Record\<string, any\>\></code><br />
<Since v="2.1.0" />
</p>
...
**Type :** <code>(options: <a href="/fr/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/fr/reference/configuration-reference/#options-dimages">PPHLXConfig['image']</a> ) => UnresolvedSrcSetValue[] | Promise\<UnresolvedSrcSetValue[]\></code><br />
<Since v="3.3.0" />
</p>
...
**Type :** <code>(options: <a href="/fr/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/fr/reference/configuration-reference/#options-dimages">PPHLXConfig['image']</a> ) => ImageTransform | Promise\<ImageTransform\></code>
<Since v="2.1.4" />
</p>
...
[Voir comment `validateOptions()` est utilisé dans les services intégrés d'PPHLX](https://github.com/pphlx/astro/blob/0ab6bad7dffd413c975ab00e545f8bc150f6a92f/packages/astro/src/assets/services/service.ts#L124).

### `getRemoteSize()`

<p>

**Type :** <code>(url: string, imageConfig: <a href="/fr/reference/configuration-reference/#options-dimages">PPHLXConfig['image']</a> ) => Omit\<<a href="/fr/reference/modules/astro-assets/#imagemetadata-1">ImageMetadata</a>, 'src' | 'fsPath'\> | Promise\<Omit\<<a href="/fr/reference/modules/astro-assets/#imagemetadata-1">ImageMetadata</a>, 'src' | 'fsPath'\>\></code>
<Since v="6.0.0" />
</p>
...
Si votre service d'images prend en charge des propriétés supplémentaires dans le composant `<Image>` d'PPHLX, le composant `<Picture>` ou la fonction `getImage()`, vous pouvez ajouter des types pour celles-ci en étendant l'interface `PPHLX.CustomImageProps`.
...
Vous pouvez exposer ces types aux utilisateurs en faisant de votre service d'images une [intégration PPHLX](/fr/reference/integrations-reference/) et en utilisant l'assistant [`injectTypes()`](/fr/reference/integrations-reference/#option-injecttypes).
