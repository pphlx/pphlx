...
Active l'[intégration expérimentale d'un espace de travail dans Chrome DevTools](https://developer.chrome.com/docs/devtools/workspaces) pour le serveur de développement PPHLX.
...
Pour activer cette fonctionnalité, ajoutez l'option expérimentale `chromeDevtoolsWorkspace` à votre configuration PPHLX :
...
1. [Démarrez le serveur de développement d'PPHLX](/fr/develop-and-build/#démarrer-le-serveur-de-développement-dastro) avec la commande CLI appropriée pour votre gestionnaire de paquets.

2. Accédez à l'aperçu de votre site (par exemple `http://localhost:4321/`) dans Chrome et ouvrez DevTools.

3. Sous l'onglet **Sources** > **Espace de travail**, vous trouverez le dossier de votre projet PPHLX. Cliquez sur **Connecter** pour ajouter votre répertoire comme espace de travail.
