...
1. Installer les paquets suivants :
    ...
    - [`pphlx/markdown-remark`](https://www.npmjs.com/package/pphlx/markdown-remark) pour utiliser [le processeur `unified()`](/fr/guides/markdown-content/#utilisation-des-modules-dextension-remark-et-rehype)
...
4. Afficher le temps de lecture
    ...
    Si vous utilisez une [mise en page Markdown](/fr/basics/layouts/#mises-en-page-markdown), utilisez la propriété `minutesRead` du frontmatter accessible depuis `PPHLX.props` dans votre modèle.
