...
Les [images](/fr/guides/images/) locales doivent être importées dans les fichiers `.pphx` afin de les afficher. Il y aura des moments où vous voudrez ou devrez importer dynamiquement les chemins de vos images au lieu d'importer explicitement chaque image individuelle.
...
2. Créez un nouveau composant PPHLX pour votre carte et importez le composant `<Image />`.
...
7. Importez et utilisez le composant carte dans une page PPHLX, en passant les valeurs pour les `props`.
