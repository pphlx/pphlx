...
Vous pouvez utiliser le module d'extension Typography de [Tailwind](https://tailwindcss.com) pour mettre en forme le rendu Markdown à partir de sources telles que les [**collections de contenu**](/fr/guides/content-collections/) d'PPHLX.

Cette recette vous apprendra à créer un composant PPHLX réutilisable pour mettre en forme votre contenu Markdown en utilisant les classes utilitaires de Tailwind.
...
Un projet PPHLX qui :
	...
	- utilise les [collections de contenu](/fr/guides/content-collections/) d'PPHLX.
