...
description: Apprendre à appeler des points de terminaison à partir du serveur dans PPHLX.
i18nReady: true
type: recipe
---
...
2. Sur n'importe quelle page PPHLX, importez la méthode `GET()` du point de terminaison. Appelez-la avec l'[objet global `PPHLX`](/fr/reference/api-reference/) pour fournir le contexte de la requête, et utilisez la réponse sur la page :
