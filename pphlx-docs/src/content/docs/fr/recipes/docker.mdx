---
title: Construisez votre site PPHLX avec Docker
description: Apprendre à construire votre site PPHLX en utilisant Docker.
type: recipe
i18nReady: true
---
...
Ce fichier Docker va compiler votre site et le servir en utilisant Node.js sur le port `4321` et nécessite donc l'[adaptateur Node](/fr/guides/integrations-guide/node/) installé dans votre projet PPHLX.
