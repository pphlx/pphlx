...
<Steps>
1. Installez [`Day.js`](https://www.npmjs.com/package/dayjs) pour modifier et formater les heures, et [`pphlx/markdown-remark`](https://www.npmjs.com/package/pphlx/markdown-remark) pour utiliser le [processeur `unified()`](/fr/guides/markdown-content/#utilisation-des-modules-dextension-remark-et-rehype) :
...
4. Afficher l'heure de la dernière modification
   ...
   Si vous utilisez une [mise en page Markdown](/fr/basics/layouts/#mises-en-page-markdown), utilisez la propriété du frontmatter `lastModified` accessible depuis `PPHLX.props` dans votre modèle de mise en page.
