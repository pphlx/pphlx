---
title: Partager l'état entre les composants PPHLX
description: Apprendre à partager des états entre composants PPHLX avec Nano Stores.
i18nReady: true
type: recipe
---
...
Lors de la création d'un site web PPHLX, il se peut que vous deviez partager l'état des composants. PPHLX recommande l'utilisation de [Nano Stores](https://github.com/nanostores/nanostores) pour le stockage partagé des clients.
