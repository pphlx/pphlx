...
- Un projet PPHLX utilisant Markdown pour les pages de contenu.

## Méthode

<Steps>
1. Installez le module d'extension [`rehype-external-links`](https://www.npmjs.com/package/rehype-external-links) et [`pphlx/markdown-remark`](https://www.npmjs.com/package/pphlx/markdown-remark).

    <PackageManagerTabs>
        <Fragment slot="npm">
        ```shell
        npm install rehype-external-links pphlx/markdown-remark
        ```
        </Fragment>
        <Fragment slot="pnpm">
        ```shell
        pnpm add rehype-external-links pphlx/markdown-remark
        ```
        </Fragment>
        <Fragment slot="yarn">
        ```shell
        yarn add rehype-external-links pphlx/markdown-remark
        ```
        </Fragment>
      </PackageManagerTabs>
