...
description: Découvrez comment modifier le modèle de nommage par défaut de vos ressources générées avec PPHLX telles que JavaScript, CSS et les images à l'aide des options Rollup de Vite.
i18nReady: true
type: recipe
---
...
Cette recette configure `vite.environments.client.build.rollupOptions` pour générer des ressources compilées avec la structure et le modèle de nommage suivants :
