---
type: tutorial
unitTitle: Créer et concevoir avec les composants UI d'PPHLX
title: 'Embarquement : Unité 3 - Composants'
description: |-
  Tutoriel : Créer votre premier blog avec PPHLX —
  Créez des composants PPHLX pour réutiliser le code des éléments communs sur votre site web
i18nReady: true
head:
  - tag: title
...
Maintenant que vous avez des fichiers `.pphx` et `.md` générant des pages entières sur votre site web, il est temps de créer et de réutiliser de plus petits morceaux d'HTML avec des composants PPHLX !

## Ce que la suite vous réserve

Dans cette unité, vous apprendrez à créer des **composants PPHLX** pour réutiliser le code des éléments communs sur votre site web.
...
<Checklist>
- [ ] Je suis prêt à créer quelques composants PPHLX !
</Checklist>
</Box>
