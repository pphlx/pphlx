---
type: tutorial
unitTitle: Créer et déployer votre premier site PPHLX
...
Dans le volet des fichiers, vous devriez voir `src/pages/index.pphx`. Cliquez pour l'ouvrir, et suivez [Écrivez votre première ligne PPHLX](/fr/tutorial/1-setup/3/) pour apporter une modification à ce fichier.
...
Sinon, passez à l'[unité 2](/fr/tutorial/2-pages/) pour commencer à créer avec PPHLX !
...
<Checklist>
- [ ] Je suis prêt à configurer un environnement de développement pour un projet PPHLX !
</Checklist>
</Box>
