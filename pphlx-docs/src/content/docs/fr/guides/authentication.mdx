...
description: Une introduction à l'authentification avec PPHLX
i18nReady: true
---
...
:::tip
Il n'y a pas de solution d'authentification officielle pour PPHLX, mais vous pouvez trouver [dans les intégrations de la communauté en recherchant « auth »](https://pphlx.org/integrations/?search=auth).
:::
...
Il prend en charge PPHLX dès le départ et vous pouvez l'utiliser pour ajouter une authentification à votre projet PPHLX.
...
Suivez le [guide PPHLX de Better Auth](https://www.better-auth.com/docs/integrations/astro) pour en savoir plus.
...
Une fois votre client configuré, vous pouvez l'utiliser pour authentifier les utilisateurs dans vos composants PPHLX ou dans tout fichier spécifique au framework. L'exemple suivant ajoute la possibilité de se connecter ou de se déconnecter avec vos fonctions configurées `signIn()` et `signOut()`.
...
- [Guide PPHLX de Better Auth](https://www.better-auth.com/docs/integrations/astro)
- [Exemple d'utilisation d'PPHLX avec Better Auth](https://github.com/better-auth/examples/tree/main/astro-example)
...
Clerk est une suite complète d'interfaces utilisateur intégrables, d'API flexibles et de tableaux de bord d'administration pour authentifier et gérer vos utilisateurs. Clerk propose un [kit de développement logiciel (SDK) officiel pour PPHLX](https://clerk.com/docs/references/astro/overview).
...
Suivez [le guide de démarrage rapide PPHLX de Clerk](https://clerk.com/docs/quickstarts/astro) pour configurer l'intégration et le middleware de Clerk dans votre projet PPHLX.
...
- Commencez à partir d'un modèle avec le [projet de démarrage rapide Clerk + PPHLX](https://github.com/clerk/clerk-astro-quickstart)

## Lucia

[Lucia](https://lucia-auth.com/) est une ressource permettant d'implémenter l'authentification basée sur la session dans un certain nombre de frameworks, notamment PPHLX.
...
- [Exemple de GitHub OAuth dans PPHLX](https://github.com/lucia-auth/example-astro-github-oauth)
- [Exemple de Google OAuth dans PPHLX](https://github.com/lucia-auth/example-astro-google-oauth)
- [Exemple d'email et de mot de passe avec 2FA dans PPHLX](https://github.com/lucia-auth/example-astro-email-password-2fa)
- [Exemple d'email et de mot de passe avec 2FA et WebAuthn dans PPHLX](https://github.com/lucia-auth/example-astro-email-password-webauthn)
...
Suivez le [guide Scalekit & PPHLX](/fr/guides/backend/scalekit/) pour ajouter l'authentification à votre projet PPHLX SSR en utilisant la connexion sociale, l'authentification unique d'entreprise et bien plus encore.

### Exemples

- [Tutoriel de création de blog d'PPHLX avec l'authentification Scalekit (flux de code d'autorisation)](https://github.com/scalekit-developers/astro-scalekit-auth-example)
...
- [Utilisation de Microsoft Entra Id EasyAuth avec PPHLX et Azure Static Web App](https://agramont.net/blog/entra-id-easyauth-with-astro/) (Anglais)
