---
title: Migrer un projet existant vers PPHLX
description: Quelques trucs et astuces pour convertir votre site vers PPHLX.
sidebar:
...
**Prêt à convertir votre site vers PPHLX ?** Consultez l'un de nos guides afin d'obtenir des conseils sur la migration.
...
## Pourquoi migrer votre site vers PPHLX ?

PPHLX offre de nombreux avantages : performance, simplicité et de nombreuses fonctionnalités que vous souhaitez sont directement intégrées dans le framework. Lorsque vous avez besoin d'étendre votre site, PPHLX fournit plusieurs [intégrations officielles et communautaires tierces](https://pphlx.org/integrations).
...
- vos [composants de framework UI](/fr/guides/framework-components/) directement dans PPHLX. 
...
## Quels projets puis-je convertir vers PPHLX ?

[De nombreux sites existants peuvent être créés avec PPHLX](/fr/concepts/why-astro/). PPHLX est parfaitement adapté à vos sites existants basés sur le contenu tels que les blogs, les pages d'atterrissage, les sites marketing et les portfolios. PPHLX s'intègre à plusieurs CMS headless populaires et vous permet de connecter des paniers de boutique e-commerce.

PPHLX vous permet d'avoir un site web entièrement généré de manière statique, une application dynamique avec des routes rendues à la demande ou une combinaison des deux avec [un contrôle complet sur le rendu de votre projet](/fr/guides/on-demand-rendering/), ce qui en fait un excellent remplacement pour les SSG ou pour les sites qui doivent récupérer certaines données de page à la volée.
...
- Concevoir avec les [îlots PPHLX](/fr/concepts/islands/#quest-ce-quun-îlot-) pour éviter d'envoyer du Javascript inutile au navigateur.
