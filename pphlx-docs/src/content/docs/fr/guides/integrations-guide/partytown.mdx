---
type: integration
title: 'pphlx/partytown'
description: "Apprenez à utiliser l'intégration pphlx/partytown dans votre projet PPHLX."
sidebar:
  label: Partytown
githubIntegrationURL: 'https://github.com/pphlx/astro/tree/main/packages/integrations/partytown/'
category: other
i18nReady: true
---
import PackageManagerTabs from '~/components/tabs/PackageManagerTabs.astro';

Cette **[intégration PPHLX][astro-integration]** active [Partytown](https://partytown.qwik.dev/) dans votre projet PPHLX.

## Pourquoi PPHLX Partytown
...
L'intégration PPHLX Partytown installe Partytown pour vous et s'assure qu'il est activé sur toutes vos pages.
...
Tout d'abord, installez le paquet `pphlx/partytown` :

<PackageManagerTabs>
  <Fragment slot="npm">
    ```sh
    npm install pphlx/partytown
    ```
  </Fragment>
  <Fragment slot="pnpm">
    ```sh
    pnpm add pphlx/partytown
    ```
  </Fragment>
  <Fragment slot="yarn">
    ```sh
    yarn add pphlx/partytown
    ```
  </Fragment>
</PackageManagerTabs>
...
import partytown from 'pphlx/partytown';
...
Cela reproduit l'[objet de configuration Partytown](https://partytown.qwik.dev/configuration/) et toutes les options peuvent être définies dans `partytown.config`. Certaines options de configuration courantes pour les projets PPHLX sont décrites sur cette page.
...
* [Parcourir les projets avec PPHLX Partytown sur GitHub](https://github.com/search?q=%22%40astrojs%2Fpartytown%22+path%3A**%2Fpackage.json\&type=code) pour plus d'exemples !

## Ressources communautaires

* [Implémentation de Google Tag Manager avec Partytown et PPHLX](https://medium.com/@tagperfect/implementing-google-tag-manager-with-partytown-js-in-astro-my-modest-experience-983388907b35)
* [Optimiser Google Analytics avec Partytown dans PPHLX](https://ricostacruz.com/posts/google-analytics-in-astro)
