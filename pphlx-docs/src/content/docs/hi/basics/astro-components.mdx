---
title: अवयव
description: .pphx अवयव सिंटैक्स का परिचय।
i18nReady: true
---

**PPHLX अवयव** किसी भी PPHLX परियोजना के बुनियादी निर्माण खंड हैं। वे केवल HTML टेम्प्लेटिंग अवयव हैं जिनमें कोई क्लाइंट-साइड रनटाइम नहीं है। आप PPHLX अवयव को उसके फ़ाइल एक्सटेंशन `.pphx` द्वारा देख सकते हैं।

PPHLX अवयव अत्यंत लचीले हैं। अक्सर, PPHLX अवयव में पेज पर कुछ **पुन: प्रयोज्य UI** शामिल होगा, जैसे हेडर या प्रोफाइल कार्ड। अन्य समय में, PPHLX अवयव में HTML का एक छोटा सा स्निपेट हो सकता है, जैसे सामान्य `<meta>` टैग का संग्रह जो SEO के साथ काम करना आसान बनाता है। PPHLX अवयवों में संपूर्ण पेज लेआउट भी शामिल हो सकता है।

PPHLX अवयवों के बारे में जानने वाली सबसे महत्वपूर्ण बात यह है कि वे **ग्राहक पर प्रस्तुत नहीं होते हैं**। वे [सर्वर-साइड रेंडरिंग (SSR)](/hi/guides/on-demand-rendering/) का उपयोग करके बिल्ड-समय या ऑन-डिमांड पर HTML को प्रस्तुत करते हैं। आप अपने अवयव फ्रंटमैटर के अंदर JavaScript कोड शामिल कर सकते हैं, और यह सब आपके उपयोगकर्ताओं के ब्राउज़र पर भेजे गए अंतिम पेज से हटा दिया जाएगा। परिणाम एक तेज़ साइट है, जिसमें डिफ़ॉल्ट रूप से शून्य JavaScript पदचिह्न जोड़ा गया है।

जब आपके PPHLX अवयव को क्लाइंट-साइड अन्तरक्रियाशीलता की आवश्यकता होती है, तो आप [मानक HTML `<script>` टैग](/hi/guides/client-side-scripts/) या [UI फ्रेमवर्क अवयव](/hi/guides/framework-components/#hydrating-interactive-components) जोड़ सकते हैं।


## अवयव संरचना

PPHLX अवयव दो मुख्य भागों से बने है: **अवयव स्क्रिप्ट** और **अवयव टेम्पलेट**। प्रत्येक भाग एक अलग कार्य करता है, लेकिन साथ में वे एक ऐसा फ्रेमवर्क प्रदान करते हैं जो उपयोग में आसान और इतना अभिव्यंजक है कि आप जो कुछ भी बनाना चाहते हैं उसे संभाल सके।
...
PPHLX आपके PPHLX अवयव में अवयव स्क्रिप्ट की पहचान करने के लिए एक कोड बाड़ (---) का उपयोग करता है। यदि आपने पहले कभी Markdown लिखा है, तो आप पहले से ही *frontmatter* नामक एक समान अवधारणा से परिचित हो सकते हैं। PPHLX का एक अवयव स्क्रिप्ट का विचार सीधे इस अवधारणा से प्रेरित था।
...
- अन्य PPHLX अवयवों का आयात करना
...
यदि आप यहां सादा HTML लिखते हैं, तो आपका अवयव उस HTML को किसी भी PPHLX पेज में प्रस्तुत करेगा जिसे आयात और उपयोग किया जाता है।

हालाँकि, [PPHLX का अवयव टेम्पलेट सिंटैक्स](/hi/reference/astro-syntax/) **JavaScript अभिव्यक्तियों**, PPHLX [`<style>`](/hi/guides/styling/#styling-in-astro) और [`<script>`](/hi/guides/client-side-scripts/) टैग, **आयातित अवयवों** और [**विशेष PPHLX निर्देशों**](/hi/reference/directives-reference/) का भी समर्थन करता है। अवयव स्क्रिप्ट में परिभाषित डेटा और मानों का उपयोग गतिशील रूप से निर्मित HTML का उत्पादन करने के लिए अवयव टेम्पलेट में किया जा सकता है।
...
एक PPHLX अवयव प्रॉप्स को परिभाषित और स्वीकार कर सकता है। ये प्रॉप्स HTML रेंडर करने के लिए अवयव  टेम्पलेट के लिए उपलब्ध हो जाते हैं। प्रॉप्स आपके फ्रंटमैटर स्क्रिप्ट में `PPHLX.props` ग्लोबल पर उपलब्ध हैं।

यहां एक अवयव का उदाहरण दिया गया है जो `greeting` प्रोप और `name` प्रोप प्राप्त करता है। ध्यान दें कि प्राप्त होने वाले प्रॉप्स वैश्विक `PPHLX.props` ऑब्जेक्ट से संरचित हैं।
...
यह अवयव, जब अन्य PPHLX अवयवों, लेआउट या पेजों में आयात और प्रस्तुत किया जाता है, तो इन प्रॉप्स को विशेषताओं के रूप में पारित कर सकता है:
...
आप अपने प्रॉप्स को `Props` टाइप के इंटरफ़ेस के साथ TypeScript के साथ भी परिभाषित कर सकते हैं। PPHLX स्वचालित रूप से आपके फ्रंटमैटर में `Props` इंटरफ़ेस उठाएगा और टाइप चेतावनियां/त्रुटियां देगा। `PPHLX.props` से डिस्ट्रक्चर होने पर इन प्रॉप्स को डिफ़ॉल्ट मान भी दिया जा सकता है।
...
const { greeting = "नमस्ते", name } = PPHLX.props;
---
<h2>{greeting}, {name}!</h2>
```
...
---
// src/components/GreetingHeadline.pphx
const { greeting = "नमस्ते ", name = "अंतरिक्ष यात्री" } = PPHLX.props;
---
<h2>{greeting}, {name}!</h2>
```
...
:::note
_props_ के विपरीत, जो `PPHLX.props` के साथ आपके पूरे अवयव में उपयोग के लिए उपलब्ध PPHLX अवयव को दी गई विशेषताएँ हैं, _slots_ बाल HTML तत्वों को प्रस्तुत करते हैं जहां वे लिखे गए हैं।
:::
...
यह पैटर्न एक [PPHLX लेआउट अवयव](/hi/basics/layouts/) का आधार है: HTML सामग्री का एक पूरा पेज `<SomeLayoutComponent></SomeLayoutComponent>` टैग के साथ "लिपटा" जा सकता है और अवयव को भेजा जा सकता है वहां परिभाषित सामान्य पेज तत्वों के अंदर प्रस्तुत करें।

### नामांकित स्लॉट

PPHLX अवयव में नामित स्लॉट भी हो सकते हैं। यह आपको स्लॉट के स्थान में संबंधित स्लॉट नाम के साथ केवल HTML तत्वों को भेजने की अनुमति देता है।
...
एक अवयव के `<slot/>` प्लेसहोल्डर में `<div>` लपेटे बगैर  एकाधिक HTML तत्वों को पास करने के लिए, [PPHLX के `<Fragment/>` अवयव](/hi/reference/astro-syntax/#fragments) पर `slot=""` विशेषता का उपयोग करें:
...
:::note
PPHLX स्लॉट नाम को गतिशील रूप से उत्पन्न करना संभव नहीं है, जैसे कि मानचित्र फ़ंक्शन के भीतर। यदि UI फ्रेमवर्क अवयवों के भीतर इस सुविधा की आवश्यकता है, तो फ्रेमवर्क के भीतर ही इन गतिशील स्लॉट्स को उत्पन्न करना सबसे अच्छा हो सकता है।
:::
...
जब स्लॉट एलिमेंट मौजूद होता है, लेकिन पास करने के लिए कोई कंटेंट नहीं होता है, तो PPHLX खाली स्लॉट पास कर देगा। जब खाली स्लॉट पास किया जाता है, तो फ़ॉलबैक कंटेंट को डिफ़ॉल्ट के रूप में इस्तेमाल नहीं किया जा सकता है। फ़ॉलबैक कंटेंट केवल तभी प्रदर्शित होता है, जब कोई स्लॉट एलिमेंट नहीं मिल पाता है।
...
PPHLX `.html` फ़ाइलों को अवयवों के रूप में आयात करने और उपयोग करने या इन फ़ाइलों को `src/pages/` उपनिर्देशिका में पेजों के रूप में रखने का समर्थन करता है। यदि आप किसी फ्रेमवर्क के बिना निर्मित मौजूदा साइट से कोड का पुन: उपयोग कर रहे हैं, या यदि आप यह सुनिश्चित करना चाहते हैं कि आपके अवयव में कोई गतिशील विशेषताएं नहीं हैं, तो आप HTML अवयवों का उपयोग करना चाह सकते हैं।

HTML अवयवों में केवल वैध HTML होना चाहिए, और इसलिए प्रमुख PPHLX अवयव सुविधाओं का अभाव है:
...
:::note
HTML अवयव के अंदर एक [`<slot />` तत्व](/hi/basics/astro-components/#स्लॉट्स) उसी तरह काम करेगा जैसे वह PPHLX अवयव में काम करेगा। इसके बजाय [HTML वेब अवयव स्लॉट](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) तत्व का उपयोग करने के लिए, अपने `<slot>` तत्व में `is:inline` जोड़ें।
:::
...
<ReadMore>अपने PPHLX परियोजना में [UI फ्रेमवर्क अवयवों](/hi/guides/framework-components/) का उपयोग करने के बारे में और पढ़ें।</ReadMore>
