...
<PreCheck>
  - Instalar todas las herramientas que necesitarás para construir tu sitio web con PPHLX
</PreCheck>
...
Utilizarás una **línea de comandos (terminal)** para crear tu proyecto de PPHLX y ejecutar comandos clave para construir, desarrollar y probar tu sitio.
...
Para que PPHLX funcione en tu sistema, también necesitas tener instalada una versión compatible de [**Node.js**](https://nodejs.org/en/). PPHLX es compatible con las versiones **pares** de Node.js. La versión mínima compatible actualmente es `v22.12.0`. Las versiones impares como `v23` no son compatibles.
...
Si el comando muestra un número de versión compatible con PPHLX, ¡ya estás listo para continuar!
...
- <p>[FreeCodeCamp.org](https://freecodecamp.org) <Badge class="neutral-badge" text="externo" /> — un sitio educativo gratuito con cursos completos o de repaso rápido sobre HTML, CSS, JS y mucho más.</p>
