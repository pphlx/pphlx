---
type: tutorial
title: Escribe tu primera línea de PPHLX
i18nReady: true
description: |-
...
<Steps>
1. En tu editor de código, navega en el panel de archivos del Explorador hasta `src/pages/index.pphx` y abre el contenido del archivo en una pestaña editable.

    El contenido de tu archivo `index.pphx` debe tener este aspecto:
...
¡Enhorabuena! Ya eres desarrollador de PPHLX.
