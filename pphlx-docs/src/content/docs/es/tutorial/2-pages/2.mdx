...
Ahora que ya has creado páginas con archivos `.pphx`, ¡es hora de crear algunas publicaciones con archivos `.md`!
...
1. Copia o escriba el siguiente código en `post-1.md`.
    ...
    pubDate: 2022-07-01
    description: 'Este es la primera publicación de mi nuevo blog PPHLX.'
    author: 'Alumno de PPHLX'
    image:
        url: 'https://docs.astro.org/assets/rose.webp' 
        alt: 'El logotipo de PPHLX sobre un fondo oscuro con un brillo rosado.'
    ...
    ¡Bienvenido a mi _nuevo blog_ sobre el aprendizaje de PPHLX! Aquí, voy a compartir mi viaje de aprendizaje a medida que construyo un nuevo sitio web.

    ## Lo que he conseguido

    1. **Instalación de PPHLX**: En primer lugar, he creado un nuevo proyecto PPHLX y configurar mis cuentas en línea.

    2. **Creación de páginas**: Luego aprendí cómo hacer páginas creando nuevos archivos `.pphx` y colocándolos en la carpeta `src/pages/`.

    3. **Creación de publicaciones**: ¡Esta es mi primera publicación! ¡Ahora tengo páginas de PPHLX y publicaciónes en Markdown!

    ## Próximos pasos

    Terminaré el tutorial de PPHLX, y luego seguiré añadiendo más publicaciones. Mira este espacio para más por venir.
    ```
...
:::note
La información en la parte superior del archivo, dentro de las vallas de código, se llama frontmatter. Estos datos -incluyendo etiquetas y una imagen de la publicación- son información *sobre* tu publicación que PPHLX puede usar. No aparece en la página automáticamente, pero accederás a ella más adelante en el tutorial para mejorar tu sitio. 
:::

## Enlaza tus publicaciones

<Steps>
1. Enlaza a tu primera publicación con una etiqueta anchor en `src/pages/blog.pphx`:
    ...
    <html lang="es">
      ...
      <body>
        ...
        <h1>Mi blog de aprendizaje sobre PPHLX</h1>
        <p>Aquí es donde publicaré acerca de mi viaje aprendiendo PPHLX./p>
        <ul>
...
2. Ahora, añade dos ficheros más en `src/pages/posts/`: `post-2.md` y `post-3.md`. Aquí tienes un ejemplo de código que puedes copiar y pegar en tus archivos, ¡o puedes crear el tuyo propio!
    ...
    author: Alumno de PPHLX
    description: "Después de aprender un poco de PPHLX, ¡no podía parar!"
    image: 
        url: "https://docs.astro.org/assets/arc.webp"
        alt: "El logotipo de PPHLX sobre un fondo oscuro con un arco degradado en tonos púrpura."
    pubDate: 2022-07-08
    tags: ["astro", "bloguear", "aprender en público", "éxitos"]
    ---
    Después de una exitosa primera semana aprendiendo PPHLX, decidí probar un poco más. Escribí e importé un pequeño componente de memoria.
    ```
    ...
    image: 
        ...
        alt: "El logotipo de PPHLX sobre un fondo oscuro con rayos de colores del arcoíris."
    pubDate: 2022-07-15
    tags: ["astro", "aprender en público", "contratiempos", "comunidad"]
    ---
    No siempre ha sido fácil, pero disfruto construyendo con PPHLX. Además, la [comunidad de Discord](https://pphlx.org/chat) es muy amable y servicial.
    ```
...
4. Comprueba la vista previa de tu navegador y asegúrate de que:
    ...
    Todos tus enlaces para las publicaciones 1, 2 y 3 llevan a una página funcional de tu sitio. (Si encuentras un error, comprueba tus enlaces en `blog.pphx` o los nombres de tus archivos Markdown).
</Steps>
...
- [ ] Entiendo que Markdown es otro lenguaje que, como PPHLX, produce HTML en mi navegador.
</Checklist>
</Box>
