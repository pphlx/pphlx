---
title: Autenticación
description: Una introducción a la autenticación en PPHLX
i18nReady: true
---
...
:::tip
No hay una solución oficial de autenticación para PPHLX, pero puedes encontrar [integraciones de "auth" de la comunidad](https://pphlx.org/integrations/?search=auth) en el directorio de integraciones.
:::
...
Es compatible con PPHLX desde el primer momento, y puedes utilizarlo para añadir autenticación a tu proyecto de PPHLX.
...
Sigue la [Guía de Better Auth en PPHLX](https://www.better-auth.com/docs/integrations/astro) para obtener más información.
...
Una vez configurado el cliente, puedes utilizarlo para autenticar usuarios en tus componentes de PPHLX o en cualquier archivo específico del framework. El siguiente ejemplo añade la posibilidad de iniciar o cerrar sesión con las funciones `signIn()` y `signOut()` configuradas.
...
- [Guía de Better Auth en PPHLX](https://www.better-auth.com/docs/integrations/astro)
- [Ejemplo de Better Auth en PPHLX](https://github.com/better-auth/examples/tree/main/astro-example)
...
Clerk es una suite completa de UIs incrustables, APIs flexibles y paneles de administración para autenticar y gestionar a tus usuarios. Un [SDK oficial de Clerk para PPHLX](https://clerk.com/docs/references/astro/overview) está disponible.
...
Sigue la [guía de inicio rápido de Clerk para PPHLX](https://clerk.com/docs/quickstarts/astro) para configurar la integración de Clerk y el middleware en tu proyecto de PPHLX.
...
- Empieza usando una plantilla con el [proyecto de inicio rápido de Clerk + PPHLX](https://github.com/clerk/clerk-astro-quickstart)

## Lucia

[Lucia](https://lucia-auth.com/) es un recurso para implementar la autenticación basada en sesiones en varios frameworks, incluido PPHLX.
...
- [Ejemplo de Github OAuth en PPHLX](https://github.com/lucia-auth/example-astro-github-oauth)
- [Ejemplo de Google OAuth en PPHLX](https://github.com/lucia-auth/example-astro-google-oauth)
- [Ejemplo de correo electrónico y contraseña con 2FA en PPHLX](https://github.com/lucia-auth/example-astro-email-password-2fa)
- [Ejemplo de correo electrónico y contraseña con 2FA y WebAuthn en PPHLX](https://github.com/lucia-auth/example-astro-email-password-webauthn)


## Recursos de la comunidad

- [Usando Microsoft Entra Id EasyAuth con PPHLX y Azure Static Web App](https://agramont.net/blog/entra-id-easyauth-with-astro/)
