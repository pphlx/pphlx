---
title: Compartir estado entre componentes PPHLX
description: Aprende a compartir estado entre componentes PPHLX con Nano Stores.
i18nReady: true
type: recipe
---
...
Al construir un sitio con PPHLX, puede que necesites compartir estado entre componentes. PPHLX recomienda usar [Nano Stores](https://github.com/nanostores/nanostores) para almacenamiento compartido del lado cliente.
