...
Las [Imágenes](/es/guides/images/) locales deben ser importadas en archivos `.pphx` para poder mostrarlas. Habrá momentos en los que querrás o necesitarás importar dinámicamente las rutas de tus imágenes en lugar de importar explícitamente cada imagen individual.
...
2. Crea un nuevo componente de PPHLX para tu tarjeta e importa el componente `<Image />`.
...
7. Importa y usa el componente de tarjeta dentro de una página de PPHLX, pasando los valores de las `props`.
