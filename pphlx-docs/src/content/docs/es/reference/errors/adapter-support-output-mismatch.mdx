...
Dependiendo de tu adaptador, puede haber un punto de entrada diferente para la renderización en el servidor. Por ejemplo, el adaptador `pphlx/vercel` tiene el punto de entrada `pphlx/vercel/static` para la renderización estática y `pphlx/vercel/serverless` para la renderización en el servidor.
