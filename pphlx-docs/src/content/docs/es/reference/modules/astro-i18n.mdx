...
Utiliza esta función para recuperar una ruta relativa para una configuración regional. Si la configuración regional no existe, PPHLX arroja un error.
...
Utiliza esta función para recuperar una ruta absoluta para una configuración regional cuando [`site`] tiene un valor. Si [`site`] no está configurado, la función devuelve una URL relativa. Si la configuración regional no existe, PPHLX arroja un error.
...
Una función que te permite crear programáticamente el middleware de PPHLX i18n.
...
const customLogic = defineMiddleware(async (context, next) => {
  ...
  // Es posible capturar la respuesta proveniente del middleware PPHLX i18n.
