...
PPHLX proporciona componentes integrados y funciones auxiliares para optimizar y mostrar tus imágenes. Para conocer las funciones y ver ejemplos de uso, [consulta nuestra guía de imágenes](/es/guides/images/).
...
Sin embargo, ambas propiedades son obligatorias para las imágenes almacenadas en tu carpeta `public/`, ya que PPHLX no puede analizar estos archivos.
