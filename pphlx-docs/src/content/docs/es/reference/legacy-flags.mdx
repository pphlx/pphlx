...
Para ayudar a algunos usuarios a migrar entre versiones de PPHLX, ocasionalmente introducimos banderas `legacy`.

Estas banderas te permiten optar por un comportamiento obsoleto o desactualizado de PPHLX en la última versión, para que puedas seguir actualizando y aprovechando las nuevas versiones de PPHLX hasta que puedas actualizar completamente el código de tu proyecto.
...
Habilita el comportamiento heredado para las colecciones de contenido (como se usaba en PPHLX v2 a v4)
