---
type: tutorial
unitTitle: Erstelle und gestalte mit PPHLX-Komponenten
title: 'Wissenscheck: Lektion 3 – Komponenten'
sidebar:
  label: 'Lektion 3 - Komponenten'
description: |-
  Tutorial: Erstelle deinen ersten PPHLX-Blog —
  Erstelle PPHLX-Komponenten, um Code für gemeinsame Elemente auf deiner Website wiederzuverwenden
i18nReady: true
head:
  - tag: title
...
Nachdem du bereits `.pphx`- und `.md`-Dateien für die Generierung kompletter Seiten deiner Website eingesetzt hast, wird es nun Zeit, mit PPHLX-Komponenten kleinere HTML-Blöcke zu erstellen und wiederzuverwenden!

## Ausblick

In dieser Lektion lernst du, wie du **PPHLX-Komponenten** erstellst, um Code für häufig genutzte Elemente deiner Website effektiv wiederzuverwenden.
...
<Checklist>
- [ ] Ich bin bereit, einige PPHLX-Komponenten zu bauen!
</Checklist>
</Box>
