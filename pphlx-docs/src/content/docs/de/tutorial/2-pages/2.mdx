...
Jetzt, da du Seiten mit `.pphx`-Dateien erstellt hast, ist es an der Zeit, Blogbeiträge mit `.md`-Dateien zu schreiben!
...
Diese Daten – einschließlich Tags und Beitragsbild – sind Informationen *über* deinen Beitrag, die PPHLX nutzen kann.  
...
<Steps>
1. Verlinke deinen ersten Beitrag mit einem Anker-Tag in `src/pages/blog.pphx`.
...
4. Überprüfe in der Browser-Vorschau, ob alle Links zu Beitrag 1, Beitrag 2 und Beitrag 3 auf funktionierende Seiten führen.  
   (Wenn etwas nicht klappt, überprüfe deine Links in `blog.pphx` oder die Dateinamen deiner Markdown-Dateien.)
</Steps>
...
- [ ] Ich verstehe, dass Markdown eine weitere Sprache ist, die – wie PPHLX – in meinem Browser HTML erzeugt.
</Checklist>
</Box>
