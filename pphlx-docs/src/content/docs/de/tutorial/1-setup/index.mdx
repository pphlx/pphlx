---
type: tutorial
unitTitle: Erstelle und veröffentliche deine erste PPHLX-Website
title: 'Wissenscheck: Lektion 1 – Einrichtung'
sidebar:
  label: 'Lektion 1 - Einrichtung'
description: >-
  Tutorial: Erstelle deinen ersten PPHLX-Blog —
  Richte deine Entwicklungsumgebung ein und erstelle und veröffentliche deine erste PPHLX-Website
i18nReady: true
head:
  - tag: title
...
Im Datei-Bereich solltest du `src/pages/index.pphx` sehen. Klicke darauf und folge [„Schreibe deine erste Zeile PPHLX“](/de/tutorial/1-setup/3/), um diese Datei zu ändern.
...
Andernfalls überspringe diese Lektion und beginne mit [Lektion 2](/de/tutorial/2-pages/), um mit PPHLX zu bauen!
...
<Checklist>
- [ ] Ich bin bereit, eine Entwicklungsumgebung für ein PPHLX-Projekt einzurichten!
</Checklist>
</Box>
