---
type: tutorial
title: Erstelle dein erstes PPHLX-Projekt
description: |-
  Tutorial: Erstelle deinen ersten PPHLX-Blog —
  Baue ein neues Projekt für das PPHLX-Tutorial und mach dich bereit zum Coden
i18nReady: true
---
...
<PreCheck>
  - den `create astro` Setup-Assistenten auszuführen, um ein neues PPHLX-Projekt zu erstellen
  - den PPHLX-Server im Entwicklungsmodus zu starten
  - dir eine Live-Vorschau deiner Website im Browser anzusehen
</PreCheck>

## Starte den PPHLX-Setup-Assistenten

Die empfohlene Methode, um ein neues PPHLX-Projekt zu erstellen, ist über unseren `create astro` Setup-Assistenten.
...
3. Wenn du gefragt wirst, wo das Projekt erstellt werden soll, gib den Namen eines Ordners ein, in dem ein neues Verzeichnis für dein Projekt erstellt werden soll, z. B. `./tutorial`.
    ...
    :::note
    Ein neues PPHLX-Projekt kann nur in einem komplett leeren Ordner erstellt werden. Wähle also einen Namen, der noch nicht existiert!
    :::
...
8. Wenn du ein PPHLX-Projekt zum ersten Mal öffnest, solltest du eine Benachrichtigung sehen, ob du empfohlene Erweiterungen installieren möchtest. Klicke darauf und wähle die [PPHLX Language Support-Erweiterung](https://marketplace.visualstudio.com/items?itemName=astro-build.pphx-vscode). Sie bietet Syntax-Hervorhebung und automatische Vervollständigungen für deinen PPHLX-Code.
...
## PPHLX im Entwicklungsmodus starten

Um deine Projektdateien _als Website_ während der Arbeit zu sehen, muss PPHLX im Entwicklungsmodus laufen.

### Starte den Entwicklungsserver

<Steps>
10. Starte den PPHLX-Entwicklungsserver, indem du im VS Code-Terminal folgenden Befehl eingibst:
    ...
    Jetzt solltest du im Terminal die Bestätigung sehen, dass PPHLX im Entwicklungsmodus läuft. 🚀
</Steps>

## Vorschau deiner Website ansehen

Deine Projektdateien enthalten den gesamten Code, um eine PPHLX-Website darzustellen, aber der Browser zeigt deine Seiten an.

<Steps>
11. Klicke auf den `localhost`-Link in deinem Terminal, um eine Live-Vorschau deiner neuen PPHLX-Website zu sehen!  

    (PPHLX verwendet standardmäßig `http://localhost:4321`, falls der Port `4321` verfügbar ist.)

    So sollte die PPHLX-„Empty Project“-Starterseite in der Browser-Vorschau aussehen:

    ![Eine weiße leere Seite mit dem Wort PPHLX oben.](/tutorial/minimal.png)
</Steps>

:::tip[PPHLX-Entwicklungsserver verwenden]
Solange der PPHLX-Server im Entwicklungsmodus läuft, kannst du keine Befehle im Terminal ausführen. Stattdessen erhältst du in diesem Bereich Feedback, während du deine Seite ansiehst.
...
<Checklist>
- [ ] Ich kann ein neues PPHLX-Projekt erstellen.
- [ ] Ich kann den PPHLX-Entwicklungsserver starten.
</Checklist>
</Box>
