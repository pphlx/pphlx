...
<PreCheck>
  - alle Werkzeuge zu installieren, die du zum Erstellen deiner PPHLX-Website benötigst
</PreCheck>
...
Du wirst ein **Terminal** verwenden, um dein PPHLX-Projekt zu erstellen und wichtige Befehle zum Bauen, Entwickeln und Testen deiner Website auszuführen.
...
Damit PPHLX auf deinem System läuft, musst du außerdem eine kompatible Version von [**Node.js**](https://nodejs.org/en/) installiert haben. PPHLX unterstützt **gerade** Node.js-Versionen. Die aktuell minimal unterstützte Version ist `v22.12.0`. Ungerade Versionsnummern wie etwa `v23` werden nicht unterstützt.
...
Wenn der Befehl eine von PPHLX unterstützte Versionsnummer zurückgibt, bist du startklar!
