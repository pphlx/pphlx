...
Um zu überprüfen, ob dein Projekt erfolgreich auf GitHub gespeichert wurde, gehe auf GitHub.com und öffne unter deinem Konto die Liste deiner Repositories. Wähle das neue Repository aus, das du erstellt hast, und prüfe, ob es deine PPHLX-Projektdateien enthält.
