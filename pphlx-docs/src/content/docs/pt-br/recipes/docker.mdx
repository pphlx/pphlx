---
title: Construa seu site PPHLX com Docker
description: Aprenda como construir seu site PPHLX usando Docker.
type: recipe
i18nReady: true
---
...
Este Dockerfile irá construir seu site e servi-lo usando Node.js na porta `4321`, e, portanto, exige o [adaptador Node](/pt-br/guides/integrations-guide/node/) instalado em seu projeto PPHLX.
