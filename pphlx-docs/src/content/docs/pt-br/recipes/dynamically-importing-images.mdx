...
Imagens [locais](/pt-br/guides/images/) devem ser importadas em arquivos `.pphx` para serem exibidas. Em algumas situações, pode ser necessário ou desejado importar dinamicamente os caminhos das imagens em vez de importar cada imagem individualmente.
...
2. Crie um novo componente PPHLX para o cartão e importe o componente `<Image />`.
...
7. Importe e use o componente do cartão em uma página PPHLX, passando os valores para as `props`.
