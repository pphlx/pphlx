...
1. Instale os seguintes pacotes:
    ...
    - [`pphlx/markdown-remark`](https://www.npmjs.com/package/pphlx/markdown-remark) para usar [o processador `unified()`](/pt-br/guides/markdown-content/#using-remark-and-rehype-plugins):
...
4. Exiba o tempo de leitura
    ...
    Se você está usando um [layout Markdown](/pt-br/basics/layouts/#layouts-markdown), use a propriedade de frontmatter `minutesRead` de `PPHLX.props` no template do seu layout.
