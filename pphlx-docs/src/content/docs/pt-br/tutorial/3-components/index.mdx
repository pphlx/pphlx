---
type: tutorial
unitTitle: Construa e projete com componentes de UI PPHLX
title: 'Check in: Unidade 3 - Componentes'
sidebar:
  label: 'Unidade 3 - Componentes'
description: |-
  Tutorial: Construa seu primeiro blog PPHLX —
  Construa componentes PPHLX para reutilizar código entre elementos comuns através do seu website
i18nReady: true
head:
  - tag: title
...
Agora que você tem arquivos `.pphx` e `.md` gerando páginas inteiras no seu website, é hora de fazer e reutilizar pequenos pedaços de HTML com componentes PPHLX!

## Olhando à frente

Nesta unidade, você irá aprender como criar **componentes PPHLX** para reutilizar código entre elementos comuns através do seu website. 
...
<Checklist>
- [ ] Eu estou pronto para construir alguns componentes PPHLX!
</Checklist>
</Box>
