...
description: >-
  ...
  Instale o pacote oficial do PPHLX para criar um feed que seus leitores podem
  se inscrever em
i18nReady: true
---
...
<PreCheck>
  - Instalar um pacote PPHLX para criar um feed RSS para seu website
  - Criar um feed que pode ser inscrito em e lido por leitores de feeds RSS
</PreCheck>

## Instale o pacote de RSS do PPHLX

PPHLX fornece um pacote customizado para rapidamente adicionar um feed RSS ao seu website.
...
<Steps>
1. Feche o servidor de desenvolvimento do PPHLX e execute o seguinte comando no terminal para instalar o pacote de RSS do PPHLX.
...
2. Reinicie o servidor de desenvolvimento para começar a trabalhar no seu projeto PPHLX novamente.
...
3. Adicione a propriedade `site` à configuração do PPHLX com a sua Netlify URL única.
...
<Checklist>
- [ ] Eu posso instalar um pacote PPHLX utilizando a linha de comando.
...
- [Geração de itens RSS no PPHLX](/pt-br/recipes/rss/#using-glob-imports)
