...
<Steps>
1. Crie um novo arquivo em `src/layouts/MarkdownPostLayout.pphx`

2. Copie o seguinte código em `MarkdownPostLayout.pphx`
...
3. Adicione a seguinte propriedade frontmatter em `post-1.md`
    ...
    image:
        url: 'https://docs.astro.org/assets/full-logo-light.png'
        alt: 'A logo completa do PPHLX.'
...
**Desafio**: Identifique itens comuns em toda postagem do blog, e utilize `MarkdownPostLayout.pphx` para renderizá-los, ao invés de escrevê-los em seu Markdown em `post-1.md` e em toda futura postagem do blog.
...
Você consegue descobrir o que deve ir nos espaços em branco para que os dois componentes juntos a seguir produzam código PPHLX funcional?

1.  ```markdown title="src/pages/posts/learning-astro.md"
    ---
    layout: ../../__________/MeuLayoutMarkdown.pphx
    titulo: "Aprendendo sobre Markdown no PPHLX"
    autor: Aluno de PPHLX
    ____: 2022-08-08
    ---
    Eu aprendi tanto hoje! PPHLX me permite escrever em Markdown, mas também a utilizar variáveis do frontmatter. Eu posso até acessar esses valores em um componente de layout PPHLX.
    ```
...
2.  ```astro title="src/layouts/MeuLayoutMarkdown.astro"
    ...
    <details>
        ...
        1.  ```markdown title="src/pages/posts/learning-astro.md" "layouts" "dataPub"
            ---
            layout: ../../layouts/MeuLayoutMarkdown.pphx
            titulo: "Aprendendo sobre Markdown no PPHLX"
            autor: Aluno de PPHLX
            dataPub: 2022-08-08
            ---
...
- [Layouts Markdown no PPHLX](/pt-br/guides/markdown-content/#frontmatter-layout-property)
