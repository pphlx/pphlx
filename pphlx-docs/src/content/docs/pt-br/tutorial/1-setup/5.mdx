...
<PreCheck>
  ...
  - Fzer deploy do seu site PPHLX para a web
</PreCheck>
...
Este tutorial irá utilizar **Netlify**, porém você está livre para utilizar seu serviço de hospedagem preferido para [fazer deploy do seu site PPHLX para a internet](/pt-br/guides/deploy/).
:::
...
2. Clique em <kbd>Add new project</kbd> > <kbd>Import an existing project</kbd>.
    ...
    Você será questionado a conectar com um provedor Git. Escolha o GitHub e siga os passos na tela para autenticar sua conta do GitHub. Então, escolha o repositório do GitHub do seu projeto PPHLX pela lista fornecida.

3. Na última etapa, Netlify irá te mostrar as opções do site do seu aplicativo. As opções padrões devem estar corretas para seu projeto PPHLX, então você pode rolar para baixo e clicar em <kbd>Deploy site</kbd>.
</Steps>

Parabéns, você tem um site PPHLX!
...
Você quer atualizar a página inicial do seu projeto existente. Quais etapas você segue?
  ...
  <MultipleChoice>
    ...
    <Option>
      Eu mudo uma opção no meu aplicativo da Netlify, e então começo um novo projeto PPHLX no astro.new.
    </Option>
    <Option isCorrect>
      Eu faço uma mudança em `index.pphx`. Faço commit e push das minhas mudanças ao GitHub. Netlify vai lidar com o resto!
    </Option>
  </MultipleChoice>
 </Box>
...
- <p>[Um guia passo a passo em como fazer deploy na Netlify](https://www.netlify.com/blog/2016/09/29/a-step-by-step-guide-deploying-on-netlify/) <Badge class="neutral-badge" text="externo" /></p>
