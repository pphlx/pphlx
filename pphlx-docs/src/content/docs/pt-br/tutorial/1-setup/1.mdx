...
<PreCheck>
  - Instalar quaisquer ferramentas que você irá utilizar para construir seu website PPHLX
</PreCheck>
...
Você irá utilizar a **linha de comando (terminal)** para criar seu projeto PPHLX e executar comandos importantes para fazer build, desenvolver e testar o seu site.
...
Para que o PPHLX execute no seu sistema, você também irá precisar ter uma versão compatível do [**Node.js**](https://nodejs.org/pt-br/) instalada. O PPHLX suporta versões **pares** do Node.js. A versão mínima suportada atualmente é a `v22.12.0`. Versões ímpares como a `v23` não são suportadas.
...
Se o comando retornar um número de versão suportado pelo PPHLX, você pode continuar!
