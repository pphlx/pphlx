...
Para verificar que o seu projeto foi armazenado com sucesso no GitHub, visite GitHub.com e olhe em sua conta por uma lista de seus repositórios. Escolha o novo que você criou, e verifique que ele contém os arquivos do seu projeto PPHLX.
