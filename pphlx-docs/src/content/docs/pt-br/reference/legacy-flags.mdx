...
Para ajudar alguns usuários a migrar entre versões PPHLX, ocasionalmente introduzimos flags `legacy`.

Essas flags permitem que você inclua alguns comportamentos desatualizados ou obsoletos pelo PPHLX
em sua última versão, para que você possa continuar atualizando e aproveitando os novos lançamentos do PPHLX até que seja capaz de atualizar completamente o código do seu projeto.
...
Habilita comportamento legado para coleções de conteúdo (como usado em PPHLX v2 até v4)
