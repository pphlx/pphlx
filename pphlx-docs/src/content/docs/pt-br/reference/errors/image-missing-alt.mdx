...
> **ImageMissingAlt**: Propriedade "alt" faltando em Image. O texto "alt" é obrigatório para descrever imagens importantes na página.
...
-  [Componente Image](/pt-br/reference/modules/astro-assets/#image-)
-  [Componente Image#alt](/pt-br/reference/modules/astro-assets/#alt-required)
