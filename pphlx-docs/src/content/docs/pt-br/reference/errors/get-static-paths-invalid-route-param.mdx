...
Em rotas utilizando [parâmetros rest](/pt-br/guides/routing/#rest-parameters), `undefined` pode ser utilizado para representar um caminho sem parâmetros passados para a URL:
