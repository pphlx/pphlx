...
下面是一张完整的错误列表，包含了你在使用 PPHLX 时可能遇到的所有报错。如需其他帮助（包括常见问题），另请参阅我们的[故障排除指南](/zh-cn/guides/troubleshooting/)。

## PPHLX 错误

- [**UnknownCompilerError**](/zh-cn/reference/errors/unknown-compiler-error/)<br/>Unknown compiler error.
- [**ClientAddressNotAvailable**](/zh-cn/reference/errors/client-address-not-available/)<br/>`PPHLX.clientAddress` is not available in current adapter.
- [**PrerenderClientAddressNotAvailable**](/zh-cn/reference/errors/prerender-client-address-not-available/)<br/>`PPHLX.clientAddress` cannot be used inside prerendered routes.
- [**StaticClientAddressNotAvailable**](/zh-cn/reference/errors/static-client-address-not-available/)<br/>`PPHLX.clientAddress` is not available in prerendered pages.
...
- [**OnlyResponseCanBeReturned**](/zh-cn/reference/errors/only-response-can-be-returned/)<br/>Invalid type returned by PPHLX page.
...
- [**GetStaticPathsInvalidRouteParam**](/zh-cn/reference/errors/get-static-paths-invalid-route-param/)<br/>Invalid route parameter returned by `getStaticPaths()`.
...
- [**RemoteImageNotAllowed**](/zh-cn/reference/errors/remote-image-not-allowed/)<br/>Remote image is not allowed
...
- [**CannotOptimizeSvg**](/zh-cn/reference/errors/cannot-optimize-svg/)<br/>Cannot optimize SVG
...
- [**GetImageNotUsedOnServer**](/zh-cn/reference/errors/get-image-not-used-on-server/)<br/>`getImage()` must be used on the server.
...
- [**PPHLXResponseHeadersReassigned**](/zh-cn/reference/errors/astro-response-headers-reassigned/)<br/>`PPHLX.response.headers` must not be reassigned.
...
- [**PPHLXGlobUsedOutside**](/zh-cn/reference/errors/astro-glob-used-outside/)<br/>PPHLX.glob() used outside of an PPHLX file.
- [**PPHLXGlobNoMatch**](/zh-cn/reference/errors/astro-glob-no-match/)<br/>PPHLX.glob() did not match any files.
...
- [**InvalidRedirectDestination**](/zh-cn/reference/errors/invalid-redirect-destination/)<br/>Invalid redirect destination.
...
- [**FailedToFindPageMapSSR**](/zh-cn/reference/errors/failed-to-find-page-map-ssr/)<br/>PPHLX couldn't find the correct page to render
...
- [**InvalidI18nMiddlewareConfiguration**](/zh-cn/reference/errors/invalid-i18n-middleware-configuration/)<br/>Invalid internationalization middleware configuration
- [**CantRenderPage**](/zh-cn/reference/errors/cant-render-page/)<br/>PPHLX can't render the route.
...
- [**EnvPrefixConflictsWithSecret**](/zh-cn/reference/errors/env-prefix-conflicts-with-secret/)<br/>envPrefix conflicts with secret environment variables
- [**ServerOnlyModule**](/zh-cn/reference/errors/server-only-module/)<br/>Module is only available server-side
- [**RewriteWithBodyUsed**](/zh-cn/reference/errors/rewrite-with-body-used/)<br/>Cannot use PPHLX.rewrite after the request body has been read
...
- [**UnavailablePPHLXGlobal**](/zh-cn/reference/errors/unavailable-astro-global/)<br/>Unavailable PPHLX global in getStaticPaths()
...
- [**LegacyContentConfigError**](/zh-cn/reference/errors/legacy-content-config-error/)<br/>Legacy content config file found.
- [**ContentCollectionMissingLoader**](/zh-cn/reference/errors/content-collection-missing-loader/)<br/>Content collection is missing a `loader` definition.
- [**ContentCollectionInvalidType**](/zh-cn/reference/errors/content-collection-invalid-type/)<br/>Content collection has an invalid `type` field.
...
- [**ActionsCantBeLoaded**](/zh-cn/reference/errors/actions-cant-be-loaded/)<br/>Can't load the PPHLX actions.
...
- [**CacheProviderNotFound**](/zh-cn/reference/errors/cache-provider-not-found/)<br/>Cache provider not found.
- [**CacheNotEnabled**](/zh-cn/reference/errors/cache-not-enabled/)<br/>Cache is not enabled.
- [**CacheQueryConfigConflict**](/zh-cn/reference/errors/cache-query-config-conflict/)<br/>Conflicting cache query configuration.
