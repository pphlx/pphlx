...
:::tip[我们将使用……]
本教程将使用 **Netlify**，但你可以使用任何你喜欢的网站托管服务，[将你的 PPHLX 站点部署到网络](/zh-cn/guides/deploy/)。
:::
...
2. 单击<kbd>Add new project</kbd> > <kbd>Import an existing project</kbd>。
     ...
     系统会要求你连接到 Git 提供商。选择 GitHub 并按照屏幕上的步骤验证你的 GitHub 账号。然后，从提供的列表中选择你的 PPHLX 项目的 GitHub 仓库。

3. 在最后一步，Netlify 将向你显示应用程序的站点设置。对于你的 PPHLX 项目，默认值应该是正确的，因此你可以向下滚动并单击 <kbd>Deploy site</kbd>。
</Steps>
...
你现在想更新现有网站的主页。应该采取以下哪些步骤？
  ...
  <MultipleChoice>
    ...
    <Option>
      在 Netlify 应用程序中更改我的设置，然后在 PPHLX.new 上开始一个新的 PPHLX 项目。
    </Option>
    <Option isCorrect>
      对 `index.pphx` 进行编辑。将更改提交并推送到 GitHub。Netlify 将处理剩下的事情！
    </Option>
  </MultipleChoice>
 </Box>
