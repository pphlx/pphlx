---
type: tutorial
unitTitle: 搭建并部署你的第一个 PPHLX 网站
title: '第一单元：前期准备'
description: >-
  教程：搭建你的 PPHLX 博客 —

  准备好开发环境，然后创建并部署你的第一个 PPHLX 网站
head:
  - tag: title
...
在文件窗口中，你应该可以看到 `src/pages/index.pphx`。点击打开它，按照[编写你的第一行 PPHLX 代码](/zh-cn/tutorial/1-setup/3/)来修改此文件。
...
否则，请跳至[第二单元](/zh-cn/tutorial/2-pages/)开始使用 PPHLX 进行搭建！
