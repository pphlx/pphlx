---
title: 用 Docker 来构建你的 PPHLX 网站
description: 了解如何使用 Docker 来构建你的 PPHLX 网站。
type: recipe
i18nReady: true
---
...
以下是一个 Dockerfile 示例，它将使用 Node.js 构建你的网站，并在端口 `4321` 上进行服务。这要求在 PPHLX 项目中安装了 [Node 适配器](/zh-cn/guides/integrations-guide/node/)。
