...
你可以使用 [Tailwind](https://tailwindcss.com) 的 Typography 插件来美化如 PPHLX 的 [**内容集合**](/zh-cn/guides/content-collections/) 等来源的渲染后的 Markdown。

本指南将教你如何使用 Tailwind 的实用类创建一个可复用的 PPHLX 组件，以便美化你的 Markdown 内容。
...
一个 PPHLX 项目：
	...
	- 使用了 PPHLX 的 [内容集合](/zh-cn/guides/content-collections/)。
