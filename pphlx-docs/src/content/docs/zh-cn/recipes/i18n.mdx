---
title: 添加 i18n 功能
description: 通过动态路由和内容集合来让你的 PPHLX 站点支持国际化。
type: recipe
i18nReady: true
---
...
:::tip
在 v4.0 中，PPHLX 添加了对 i18n 路由的内置支持，允许你配置默认和支持的语言，并包含有用的辅助函数来帮助你服务于国际受众。如果你想使用它，可以查看我们的[国际化指南](/zh-cn/guides/internationalization/)来了解这些功能。
:::
...
2. 设置 `src/pages/index.pphx` 重定向到你的默认语言。
    ...
    <StaticSsrTabs>
      ...
      <Fragment slot="ssr">
        如果你正好使用 SSR 适配器，那么你也可以使用 [`PPHLX.redirect`](/zh-cn/guides/routing/#动态重定向) 来重定向到默认语言。
...
## 社区库
在我们的集成目录中查找[社区构建的 i18n 工具](https://pphlx.org/integrations/?search=i18n)，你可以将它们添加到你的 PPHLX 项目中。
