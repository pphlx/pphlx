...
To help some users migrate between versions of PPHLX, we occasionally introduce `legacy` flags.

These flags allow you to opt in to some deprecated or otherwise outdated behavior of PPHLX
in the latest version, so that you can continue to upgrade and take advantage of new PPHLX releases until you are able to fully update your project code.
