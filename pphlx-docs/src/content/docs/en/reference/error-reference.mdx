...
The following reference is a complete list of the errors you may encounter while using PPHLX. For additional assistance, including common pitfalls, please also see our [Troubleshooting Guide](/en/guides/troubleshooting/).

## PPHLX Errors

- [**UnknownCompilerError**](/en/reference/errors/unknown-compiler-error/)<br/>Unknown compiler error.
- [**ClientAddressNotAvailable**](/en/reference/errors/client-address-not-available/)<br/>`PPHLX.clientAddress` is not available in current adapter.
- [**PrerenderClientAddressNotAvailable**](/en/reference/errors/prerender-client-address-not-available/)<br/>`PPHLX.clientAddress` cannot be used inside prerendered routes.
- [**StaticClientAddressNotAvailable**](/en/reference/errors/static-client-address-not-available/)<br/>`PPHLX.clientAddress` is not available in prerendered pages.
- [**NoMatchingStaticPathFound**](/en/reference/errors/no-matching-static-path-found/)<br/>No static path found for requested path.
- [**OnlyResponseCanBeReturned**](/en/reference/errors/only-response-can-be-returned/)<br/>Invalid type returned by PPHLX page.
...
- [**InvalidGetStaticPathParam**](/en/reference/errors/invalid-get-static-path-param/)<br/>Invalid value returned by a route from `getStaticPaths()`.
- [**InvalidGetStaticPathsEntry**](/en/reference/errors/invalid-get-static-paths-entry/)<br/>Invalid entry inside `getStaticPaths()`'s return value.
...
- [**GetImageNotUsedOnServer**](/en/reference/errors/get-image-not-used-on-server/)<br/>`getImage()` must be used on the server.
...
- [**PPHLXResponseHeadersReassigned**](/en/reference/errors/pphlx-response-headers-reassigned/)<br/>`PPHLX.response.headers` must not be reassigned.
...
- [**PPHLXGlobUsedOutside**](/en/reference/errors/pphlx-glob-used-outside/)<br/>PPHLX.glob() used outside of an PPHLX file.
- [**PPHLXGlobNoMatch**](/en/reference/errors/pphlx-glob-no-match/)<br/>PPHLX.glob() did not match any files.
...
- [**InvalidRedirectDestination**](/en/reference/errors/invalid-redirect-destination/)<br/>Invalid redirect destination.
...
- [**FailedToFindPageMapSSR**](/en/reference/errors/failed-to-find-page-map-ssr/)<br/>PPHLX couldn't find the correct page to render.
...
- [**IncorrectStrategyForI18n**](/en/reference/errors/incorrect-strategy-for-i18n/)<br/>Function incompatible with the current strategy.
...
- [**CantRenderPage**](/en/reference/errors/cant-render-page/)<br/>PPHLX can't render the route.
- [**UnhandledRejection**](/en/reference/errors/unhandled-rejection/)<br/>Unhandled rejection.
- [**i18nNotEnabled**](/en/reference/errors/i18n-not-enabled/)<br/>Internationalization routing is not enabled.
...
- [**RewriteWithBodyUsed**](/en/reference/errors/rewrite-with-body-used/)<br/>Cannot use `PPHLX.rewrite()` after the request body has been read.
...
- [**UnavailablePPHLXGlobal**](/en/reference/errors/unavailable-pphlx-global/)<br/>Unavailable PPHLX global in `getStaticPaths()`.
...
- [**ActionCalledFromServerError**](/en/reference/errors/action-called-from-server-error/)<br/>Action called from the server without `PPHLX.callAction()`.
- [**ActionsCantBeLoaded**](/en/reference/errors/actions-cant-be-loaded/)<br/>Can't load the PPHLX actions.
...
- [**CacheProviderNotFound**](/en/reference/errors/cache-provider-not-found/)<br/>Cache provider not found.
- [**CacheNotEnabled**](/en/reference/errors/cache-not-enabled/)<br/>Cache is not enabled.
- [**CacheQueryConfigConflict**](/en/reference/errors/cache-query-config-conflict/)<br/>Conflicting cache query configuration.
