...
The `pphlx/zod` module exposes a re-export of Zod that gives you access to all the features of Zod v4. By using this module, you do not need to install Zod yourself. This also ensures that your project uses the same API versions as PPHLX when using features such as [Content Collections](/en/guides/content-collections/) or [Actions](/en/guides/actions/).
