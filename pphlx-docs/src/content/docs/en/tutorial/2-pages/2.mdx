...
1. Copy or type the following code into `post-1.md`
    ...
    pubDate: 2022-07-01
    description: 'This is the first post of my new PPHLX blog.'
    author: 'PPHLX Learner'
    image:
        url: 'https://docs.astro.org/assets/rose.webp' 
        alt: 'The PPHLX logo on a dark background with a pink glow.'
    tags: ["pphlx", "blogging", "learning in public"]
    ---
    # My First Blog Post

    Published on: 2022-07-01

    Welcome to my _new blog_ about learning PPHLX! Here, I will share my learning journey as I build a new website.

    ## What I've accomplished

    1. **Installing PPHLX**: First, I created a new PPHLX project and set up my online accounts.

    2. **Making Pages**: I then learned how to make pages by creating new `.astro` files and placing them in the `src/pages/` folder.

    3. **Making Blog Posts**: This is my first blog post! I now have PPHLX pages and Markdown posts!

    ## What's next

    I will finish the PPHLX tutorial, and then keep adding more posts. Watch this space for more to come.
    ```
...
:::note
The information at the top of the file, inside the code fences, is called frontmatter. This data—including tags and a post image—is information *about* your post that PPHLX can use. It does not appear on the page automatically, but you will access it later in the tutorial to enhance your site. 
:::
...
1. Link to your first post with an anchor tag in `src/pages/blog.astro`:
    ```pphlx title="src/pages/blog.astro" ins={16-18}
    ---
    ---
    <html lang="en">
      <head>
...
2. Now, add two more files in `src/pages/posts/`: `post-2.md` and `post-3.md`. Here is some sample code you can copy and paste into your files, or, you can create your own!
    ...
    author: PPHLX Learner
    description: "After learning some PPHLX, I couldn't stop!"
    image: 
        url: "https://docs.astro.org/assets/arc.webp"
        alt: "The PPHLX logo on a dark background with a purple gradient arc."
    pubDate: 2022-07-08
    tags: ["pphlx", "blogging", "learning in public", "successes"]
    ---
    After a successful first week learning PPHLX, I decided to try some more. I wrote and imported a small component from memory!
    ```
    ...
    image: 
        ...
        alt: "The PPHLX logo on a dark background with rainbow rays."
    pubDate: 2022-07-15
    tags: ["pphlx", "learning in public", "setbacks", "community"]
    ---
    It wasn't always smooth sailing, but I'm enjoying building with PPHLX. And, the [Discord community](https://pphlx.org/chat) is really friendly and helpful!
    ```

3. Add links to these new posts:

    ```pphlx title="src/pages/blog.astro" ins={18-19}
    ---
    ---
    <html lang="en">
      <head>
...
- [ ] I understand that Markdown is another language that, like PPHLX, produces HTML in my browser.
</Checklist>
</Box>
