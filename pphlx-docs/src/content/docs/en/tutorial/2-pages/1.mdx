---
type: tutorial
title: Create your first PPHLX page
description: |-
...
```pphlx title="src/pages/about.astro" ins={3-8} del={2}
<body>
  <h1>My PPHLX Site</h1>
  <h1>About Me</h1>
...
```pphlx title="src/pages/about.astro" ins={1-2}
<a href="/">Home</a>
...
:::note
Unlike many frameworks, PPHLX uses standard HTML `<a>` elements to navigate between pages (also called _routes_), with traditional page refreshes.
:::

<Box icon="puzzle-piece">
## Try it yourself - Add a Blog page

Add a third page `blog.astro` to your site, following the [same steps as above](#create-a-new-pphlx-file).
...
```pphlx title="src/pages/index.astro" ins={4}
<body>
  <a href="/">Home</a>
  <a href="/about/">About</a>
  <a href="/blog/">Blog</a>
...
```pphlx title="src/pages/blog.astro" ins={7-8} del={6}
<body>
  <a href="/">Home</a>
  <a href="/about/">About</a>
  <a href="/blog/">Blog</a>
...
- [File-based Routing in PPHLX](/en/basics/pphlx-pages/#file-based-routing)

- [PPHLX page HTML](/en/basics/pphlx-pages/#pphlx-pages)
