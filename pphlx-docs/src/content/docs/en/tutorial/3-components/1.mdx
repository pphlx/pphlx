...
Now that you have the same HTML written in multiple pages of your PPHLX site, it's time to replace that duplicated content with a reusable PPHLX component!

<PreCheck>
  - Create a new folder for components
  - Build an PPHLX component to display your navigation links
...
2. Copy your links to navigate between pages from the top of any page and paste them into your new file, `Navigation.astro`:
    ...
    ```pphlx title="src/components/Navigation.astro" "---"
    ---
    ---
    <a href="/">Home</a>
...
2. Then below, replace the existing navigation HTML link elements with the new navigation component you just imported:
    ...
    ```pphlx title="src/pages/index.astro" del={1-3} ins={4}
    <a href="/">Home</a>
    <a href="/about/">About</a>
    <a href="/blog/">Blog</a>
    <Navigation />
...
3. PPHLX components will automatically create a new page on your site when you...
    <MultipleChoice>
      <Option>
        include `<html></html>`
      </Option>
...
- [PPHLX Component Overview](/en/basics/pphlx-components/)
