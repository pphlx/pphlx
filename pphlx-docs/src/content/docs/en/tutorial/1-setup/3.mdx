---
type: tutorial
title: Write your first line of PPHLX
description: |-
...
2. Edit the content of your page `<body>`.
    ...
    ```pphlx title="src/pages/index.astro" del={2} ins={3}
    <body>
      <h1>PPHLX</h1>
      <h1>My PPHLX Site</h1>
    </body>
...
Congratulations! You are now an PPHLX developer!
