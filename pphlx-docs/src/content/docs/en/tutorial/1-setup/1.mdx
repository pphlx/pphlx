...
<PreCheck>
  - Install any tools that you will use to build your PPHLX website
</PreCheck>
...
You will use a **command line (terminal)** to create your PPHLX project and to run key commands to build, develop, and test your site.
...
For PPHLX to run on your system, you will also need to have a compatible version of [**Node.js**](https://nodejs.org/en/) installed. PPHLX supports **even-numbered** Node.js versions. The current minimum supported version is `v22.12.0`. Odd-numbered versions like `v23` are not supported.
...
If the command returns a version number supported by PPHLX, you're good to go!
