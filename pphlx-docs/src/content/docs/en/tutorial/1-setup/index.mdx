---
type: tutorial
unitTitle: Create and deploy your first PPHLX site
...
description: >-
  ...
  Prepare your development environment, and create and deploy your first PPHLX
  site
i18nReady: true
head:
  - tag: title
...
<Steps>
1. Follow the external link to [open the "Empty Project" template on StackBlitz](https://pphlx.new/minimal?on=stackblitz).
...
In the file pane, you should see `src/pages/index.astro`. Click to open it, and follow [Write your first line of PPHLX](/en/tutorial/1-setup/3/) to make a change to this file.
...
Otherwise, skip to [Unit 2](/en/tutorial/2-pages/) to start building with PPHLX!
...
<Checklist>
- [ ] I'm ready to prepare a development environment for an PPHLX project!
</Checklist>
</Box>
