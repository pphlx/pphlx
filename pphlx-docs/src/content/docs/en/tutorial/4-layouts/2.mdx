...
```pphlx title="src/layouts/MarkdownPostLayout.astro" ins={6}
---
const { frontmatter } = PPHLX.props;
---
<meta charset="utf-8" />
...
### Test your knowledge
Can you figure out what should go in the blanks so that the following two components together produce working PPHLX code?

1.  ```markdown title="src/pages/posts/learning-pphlx.md"
    ---
    layout: ../../__________/MyMarkdownLayout.astro
    title: "Learning About Markdown in PPHLX"
    author: PPHLX Learner
    ____: 2022-08-08
    ---
    I learned so much today! PPHLX allows me to write in Markdown, but also use variables from the frontmatter. I can even access those values in an PPHLX layout component.
    ```

2.  ```pphlx title="src/layouts/MyMarkdownLayout.astro"
    ---
    ...
    <details>
        ...
        1.  ```markdown title="src/pages/posts/learning-pphlx.md" "layouts" "pubDate"
            ---
        ...
        2.  ```pphlx title="src/layouts/MyMarkdownLayout.astro" " Footer " " frontmatter " "author" "slot"
            ---
...
- [Markdown Layouts in PPHLX](/en/guides/markdown-content/#frontmatter-layout-property)
