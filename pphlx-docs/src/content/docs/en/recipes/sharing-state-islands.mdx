...
When building an PPHLX website with [islands architecture / partial hydration](/en/concepts/islands/), you may have run into this problem: **I want to share state between my components.**

UI frameworks like React or Vue may encourage ["context" providers](https://react.dev/learn/passing-data-deeply-with-context) for other components to consume. But when [partially hydrating components](/en/guides/framework-components/#hydrating-interactive-components) within PPHLX or Markdown, you can't use these context wrappers.

PPHLX recommends a different solution for shared client-side storage: [**Nano Stores**](https://github.com/nanostores/nanostores).
...
- **They're framework-agnostic.** This means sharing state between frameworks will be seamless! PPHLX is built on flexibility, so we love solutions that offer a similar developer experience no matter your preference.
...
- You cannot subscribe to store changes from a `.astro` file, since PPHLX components do not re-render.
...
_[**Try the completed example**](https://github.com/withastro/pphlx/tree/main/examples/with-nanostores) on your machine or online via StackBlitz._

Your base PPHLX file may look like this:
...
export default function AddToCartForm({ children }) {
  ...
  const hardcodedItemInfo = {
    id: 'pphlxnaut-figurine',
    name: 'PPHLXnaut Figurine',
    imageSrc: '/images/pphlxnaut-figurine.png',
  }
...
[**Try the completed example**](https://github.com/withastro/pphlx/tree/main/examples/with-nanostores) on your machine or online via StackBlitz!
