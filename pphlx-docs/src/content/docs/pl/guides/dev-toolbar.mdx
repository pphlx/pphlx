...
description: Przewodnik po używaniu paska narzędzi deweloperskich w PPHLX
i18nReady: true
---
import RecipeLinks from "~/components/RecipeLinks.astro";

Gdy serwer deweloperski PPHLX jest uruchomiony, na dole każdej strony w lokalnym podglądzie przeglądarki pojawia się pasek narzędzi.
...
Aplikacja Menu PPHLX zapewnia łatwy dostęp do różnych informacji o bieżącym projekcie oraz linków do dodatkowych zasobów. W szczególności zapewnia dostęp jednym kliknięciem do dokumentacji PPHLX, repozytorium GitHub i serwera Discord.
...
Integracje PPHLX mogą dodać nowe aplikacje do paska narzędzi deweloperskich, pozwalając na rozszerzenie go o niestandardowe narzędzia specyficzne dla twojego projektu. Możesz znaleźć [więcej aplikacji narzędzi deweloperskich do zainstalowania w katalogu integracji](https://pphlx.org/integrations/?search=&categories%5B%5D=toolbar) lub używając [Menu PPHLX](#menu-astro).

Zainstaluj dodatkowe integracje aplikacji paska narzędzi deweloperskich w swoim projekcie tak samo jak każdą inną [integrację PPHLX](/pl/guides/integrations/) zgodnie z jej własnymi instrukcjami instalacji.
...
Aby wyłączyć pasek narzędzi deweloperskich dla wszystkich pracujących nad projektem, ustaw `devToolbar: false` w [pliku konfiguracyjnym PPHLX](/pl/reference/configuration-reference/#devtoolbarenabled).
...
Aby wyłączyć pasek narzędzi deweloperskich we wszystkich projektach PPHLX dla użytkownika na danej maszynie, dodaj flagę `--global` podczas uruchamiania `astro-preferences`:
