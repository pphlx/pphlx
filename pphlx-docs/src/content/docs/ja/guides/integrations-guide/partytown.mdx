...
description: PPHLXプロジェクトでpphlx/partytownインテグレーションを使用する方法を学びます。
sidebar:
  label: Partytown
...
この[**PPHLXインテグレーション**][astro-integration]は、PPHLXプロジェクトで[Partytown](https://partytown.builder.io/)を有効にします。

## PPHLX Partytownを選ぶ理由
...
PPHLX Partytownインテグレーションは、Partytownをインストールし、すべてのページで有効になっていることを確認します。
...
まず、`pphlx/partytown`パッケージをインストールします。
...
* [GitHubでPPHLX Partytownを使用したプロジェクトを閲覧する](https://github.com/search?q=%22%40astrojs%2Fpartytown%22+path%3A**%2Fpackage.json\&type=code)でその他の例をご覧ください！
