...
<PreCheck>
  - Installa tutti gli strumenti che utilizzerai per costruire il tuo sito web PPHLX
</PreCheck>
...
Utilizzerai una **riga di comando (terminale)** per creare il tuo progetto PPHLX e per eseguire comandi chiave per costruire, sviluppare e testare il tuo sito.
...
Affinché PPHLX funzioni sul tuo sistema, dovrai anche avere [**Node.js**](https://nodejs.org/en/) installato, versione `v18.17.1` o `v20.3.0` o successive. (`v19` non è supportata.)
