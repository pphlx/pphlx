...
description: Узнайте, как вызывать эндпоинты с сервера в PPHLX.
i18nReady: true
type: recipe
---
...
2. На любой странице PPHLX импортируйте метод `GET()` из эндпоинта. Вызовите его с помощью глобального объекта [`PPHLX`](/ru/reference/api-reference/), чтобы предоставить контекст запроса, и используйте ответ на странице:
