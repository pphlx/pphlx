...
4. Отобразите время последнего изменения
   ...
   Если вы используете [макет Markdown](/ru/basics/layouts/#markdown-макеты), используйте свойство frontmatter `lastModified` из `PPHLX.props` в вашем шаблоне макета.
