		...
		items: [
			group('ecosystem.integrations.ui', {
				...
				items: [
					...
					'guides/integrations-guide/angular',
					'guides/integrations-guide/alpinejs',
					'guides/integrations-guide/lit',
					'guides/integrations-guide/mithril',
					'guides/integrations-guide/nextjs',
					'guides/integrations-guide/nuxt',
					'guides/integrations-guide/qwik',
					'guides/integrations-guide/elm',
					'guides/integrations-guide/ember',
					'guides/integrations-guide/ziko',
					'guides/integrations-guide/threejs',
					'guides/integrations-guide/r3f',
					'guides/integrations-guide/threlte',
					'guides/integrations-guide/tresjs',
				],
			}),
			group('ecosystem.integrations.other', {
				...
				items: [
					...
					'guides/integrations-guide/bootstrap',
					'guides/integrations-guide/uno',
