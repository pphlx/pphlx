...
<body class="bg-[#080a0d] min-h-screen flex items-center justify-center p-6">
  ...
  <div class="max-w-sm mx-auto bg-[#0f1115]/95 border border-[#1f2430] rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden relative group hover:border-[#4bf3c8]/50 transition-all duration-500">
    ...
    <div id="pphlx-productimage-1784102204832483800" class="pphlx-island" data-component="ProductImage" data-framework="react" data-hydrate="load"></div>
<script>
  window.pphlxProps = window.pphlxProps || {};
  window.pphlxProps["pphlx-productimage-1784102204832483800"] = {"url": <?php echo json_encode($imageUrl); ?>,"badge": <?php echo json_encode($badgeText); ?>};
</script>
    ...
    <div class="p-6">
      ...
      <div id="pphlx-starrating-1784102204832483800" class="pphlx-island" data-component="StarRating" data-framework="solid" data-hydrate="load"></div>
<script>
  window.pphlxProps = window.pphlxProps || {};
  window.pphlxProps["pphlx-starrating-1784102204832483800"] = {"initialRating": <?php echo json_encode($initialStars); ?>};
</script>
      ...
      <div class="flex items-center justify-between mt-4">
        ...
        <div id="pphlx-buybutton-1784102204832483800" class="pphlx-island" data-component="BuyButton" data-framework="svelte" data-hydrate="load"></div>
<script>
  window.pphlxProps = window.pphlxProps || {};
  window.pphlxProps["pphlx-buybutton-1784102204832483800"] = {"stock": <?php echo json_encode($availableStock); ?>};
</script>
