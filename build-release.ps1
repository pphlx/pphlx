...
Write-Host "Building PPHLX v1.1.2 Release Tarballs..." -ForegroundColor Cyan
...
Write-Host "All v1.1.2 Release Tarballs built successfully in $ReleasesDir!" -ForegroundColor Green
Write-Host "------------------------------------------------" -ForegroundColor Green
